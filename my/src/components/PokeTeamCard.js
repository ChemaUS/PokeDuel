        ...
        <div className="statsBar">
          ...
          <p>
            ...
            <input
              ...
              step="4"
              value={hpEvs}
              onChange={(e) => setHpEvs(e.target.value)}
            ></input>
            <input
              type="range"
              id="ev-hp-range"
          ...
          <p>
            ...
            <input
              ...
              step="4"
              value={atkEvs}
              onChange={(e) => setAtkEvs(e.target.value)}
            ></input>
            <input
              type="range"
              id="ev-hp-range"
          ...
          <p>
            ...
            <input
              ...
              step="4"
              value={defenseEvs}
              onChange={(e) => setDefenseEvs(e.target.value)}
            ></input>
            <input
              type="range"
              id="ev-hp-range"
          ...
          <p>
            ...
            <input
              ...
              step="4"
              value={spAtkEvs}
              onChange={(e) => setSpAtkEvs(e.target.value)}
            ></input>
            <input
              type="range"
              id="ev-hp-range"
          ...
          <p>
            Special defense: {team["spdefense"]}
            <input
              type="number"
              id="ev-hp-number"
              min="0"
              ...
              step="4"
              value={spDefenseEvs}
              onChange={(e) => setSpDefenseEvs(e.target.value)}
            ></input>
            <input
              type="range"
              id="ev-hp-range"
          ...
          <p>
            ...
            <input
              ...
              step="4"
              value={speedEvs}
              onChange={(e) => setSpeedEvs(e.target.value)}
            ></input>
            <input
              type="range"
              id="ev-hp-range"
